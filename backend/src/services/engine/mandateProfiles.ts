...
import { MandateAllocation, MandateName, FundCandidate } from '../../models/types';

// ---------------------------------------------------------------------------
// Risk Mandate Profiles (all 5 profiles from the spreadsheet)
// ---------------------------------------------------------------------------

export const RISK_MANDATES: Record<MandateName, MandateAllocation> = {
  Conservative: {
    name: 'Conservative',
    large_cap: 0.60,
    mid_cap:   0.10,
...
export const DEFAULT_FUND_UNIVERSE: FundCandidate[] = [
 ...
 */
export const BUCKET_TO_BUY_RULE: Partial<Record<string, string>> = {
